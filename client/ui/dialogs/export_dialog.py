...
class Ui_exportDialog(object):
    def setupUi(self, exportDialog, from_db=True, df=None):
        ...
        self.verticalLayoutWidget.setAttribute(Qt.WA_NoSystemBackground)
        self.verticalLayoutWidget_2.setAttribute(Qt.WA_NoSystemBackground)
        self.verticalLayoutWidget_4.setAttribute(Qt.WA_NoSystemBackground)
        self.horizontalLayoutWidget.setAttribute(Qt.WA_NoSystemBackground)
    ...
    def export(self):
        ...
        if reply == QtWidgets.QMessageBox.Yes:          
            ...
            if platform.system() == 'Darwin':       # macOS
                subprocess.call(('open', self.outpath))
            elif platform.system() == 'Windows':    # Windows
                os.startfile(self.outpath)
            else:                                   # linux variants
                subprocess.call(('xdg-open', self.outpath))
